CREATE DATABASE `sky_take_out` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `sky_take_out`;
...
CREATE TABLE `category` (
  ...
  `store_id` bigint DEFAULT NULL COMMENT '所属商家id',
  PRIMARY KEY (`id`)
...
CREATE TABLE `dish` (
  ...
  `store_id` bigint DEFAULT NULL COMMENT '所属商家id',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=99 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin COMMENT='菜品';
...
CREATE TABLE `employee` (
  ...
  `create_user` bigint DEFAULT NULL COMMENT '创建人',
  `update_user` bigint DEFAULT NULL COMMENT '修改人',
  `store_id` bigint DEFAULT NULL COMMENT '所属店铺id，NULL为平台管理员',
  PRIMARY KEY (`id`),
  UNIQUE KEY `idx_username` (`username`)
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin COMMENT='员工信息';
...
CREATE TABLE `orders` (
  ...
  `store_id` bigint DEFAULT NULL COMMENT '所属商家id',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin COMMENT='订单表';
...
CREATE TABLE `store` (
  ...
  `category` varchar(50) DEFAULT NULL COMMENT '主营分类',
  `rating` double DEFAULT '4.5' COMMENT '评分',
  `monthly_sales` int DEFAULT '0' COMMENT '月售',
  `delivery_time` int DEFAULT '30' COMMENT '预计配送时长(分钟)',
  `distance_km` double DEFAULT '1' COMMENT '距离(公里)',
  `photo` varchar(500) DEFAULT NULL COMMENT '店铺图片',
  `min_price` decimal(10,2) DEFAULT '0.00' COMMENT '起送价',
  `deliver_fee` decimal(10,2) DEFAULT '0.00' COMMENT '配送费',
  `address` varchar(200) DEFAULT NULL COMMENT '店铺地址',
  `longitude` decimal(10,6) DEFAULT NULL COMMENT '经度',
  `latitude` decimal(10,6) DEFAULT NULL COMMENT '纬度',
  `status` int DEFAULT '1' COMMENT '1营业 0打烊',
  `create_time` datetime DEFAULT CURRENT_TIMESTAMP,
  `update_time` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `create_user` bigint DEFAULT NULL,
  `update_user` bigint DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='商家店铺信息';
...
CREATE TABLE `user` (
  ...
  `last_login_ip` varchar(64) COLLATE utf8mb3_bin DEFAULT NULL COMMENT '最近登录IP',
